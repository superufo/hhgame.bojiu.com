...
func NewServerCfg() *serverCfg {
	protocol := viper.Vp.GetString("ser.hhgame.protocol")
	ip := viper.Vp.GetString("ser.hhgame.ip")
	port := viper.Vp.GetInt("ser.hhgame.port")
	etcdServer := viper.Vp.GetStringSlice("ser.hhgame.etcdServer")
	regKey := viper.Vp.GetString("ser.hhgame.regKey")
